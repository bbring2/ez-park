...
CREATE TABLE `ezpark`.`membership` (
                                       ...
                                       `start_date` VARCHAR(20) NOT NULL DEFAULT '21-02-16',
                                       `end_date` VARCHAR(20) NOT NULL DEFAULT '21-02-23',
...
CREATE TABLE `ezpark`.`coupon` (
                                   ...
                                   `issued_date` VARCHAR(20) NOT NULL DEFAULT '01-01-2023',
                                   `expired_date` VARCHAR(20) NOT NULL DEFAULT '31-12-2023',
